<?php
class CoolShipping_Coolrunner_Block_Adminhtml_System_Config_FieldMappingRates extends Mage_Adminhtml_Block_System_Config_Form_Field_Array_Abstract
{
    protected $_block;
    ...
    {
        $this->addColumn('carrier_product_service', array(
            'label' => Mage::helper('coolrunner')->__('Carrier Product Service'),
            'renderer' => $this->_getBlockToRenderer('carrierProductService'),//$this->_getBlockToRenderer('carrierProductService'),
        ...
        $this->addColumn('condition_from', array(
            ...
            'renderer' => 'text',
            'class' => 'condition_from',
        ));
        $this->addColumn('condition_to', array(
            'label' => Mage::helper('coolrunner')->__('Condition til (excl.)'),
            'renderer' => 'text',
            'class' => 'condition_to',
        ));
        ...
        $this->addColumn('sortable', array(
            'label' => Mage::helper('coolrunner')->__('Sort'),
